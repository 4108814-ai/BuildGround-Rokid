#!/usr/bin/env python3
"""Apply only BuildGround ownership metadata to pristine upstream Nexus 1.4.5.

No runtime routing, launcher, telephony, assistant, meeting, relay, audio, or glasses
behavior is changed here. The runtime source baseline remains Anezium/Rokid-Nexus
v1.4.5; CI changes only update ownership URLs and forward-only version numbers.
"""
...
for gradle in (PHONE_GRADLE, GLASSES_GRADLE):
    replace_once(gradle, "versionCode = 10405", "versionCode = 10417")
    replace_once(gradle, 'versionName = "1.4.5"', 'versionName = "1.4.17"')
...
print("Applied clean BuildGround 1.4.17 ownership patch to upstream Nexus 1.4.5.")
