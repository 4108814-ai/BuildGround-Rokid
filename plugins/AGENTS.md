...
| Capabilities | subset of `surfaces`, `http_proxy`, `microphone`, `camera`, `mediasync` (microphone is user-approvable; no Android `RECORD_AUDIO` needed — PCM arrives over the hub) |
