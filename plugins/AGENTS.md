...
| Capabilities | subset of `surfaces`, `http_proxy`, `microphone`, `stt`, `camera` (`stt` grants hub-produced text without raw PCM; microphone needs no Android `RECORD_AUDIO` because PCM arrives over the hub) |
