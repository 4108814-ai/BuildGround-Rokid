...
internal data class RelayReaderDocument(
    ...
    companion object {
        ...
        fun from(
            ...
            while (keptMessages.isNotEmpty() && segments.exceedsDocumentBudget()) {
                keptMessages = keptMessages.drop(1)
        ...
        private fun List<RelayReaderSegment>.exceedsDocumentBudget(): Boolean =
            size > MAX_SEGMENTS || sumOf { it.text.length } > MAX_DOCUMENT_CHARS
